namespace Crosstales.FB.Util
{
    ...
    public abstract class Constants : Common.Util.BaseConstants
    {
        ...
        public const string ASSET_VERSION = "2018.3.0";

        /// <summary>Build number of the asset.</summary>
        public const int ASSET_BUILD = 20181008;
        ...
        public static readonly System.DateTime ASSET_CHANGED = new System.DateTime(2018, 10, 8);
